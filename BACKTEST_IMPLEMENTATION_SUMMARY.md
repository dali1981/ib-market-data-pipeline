...
# Run backtest (TODO: Full engine integration)
# result = backtest.run(strategy, data_provider, ...)
```
...
**dlt-ibapi/backtest/** (2 files):
- `__init__.py` (15 lines)
- `data_providers.py` (400 lines)
...
### Phase 7: Full Backtest Engine Integration
**Priority**: High (for production use)

Currently, the CLI validates configuration but doesn't run full backtests.

**TODO**:
1. Integrate tools/ `Backtest` engine
2. Add results export (CSV, JSON)
3. Add equity curve plotting
4. Add trade-level analysis
5. Add performance metrics report
...
**Next Action**:
1. Test CLI command with sample data
2. Add full backtest engine integration
