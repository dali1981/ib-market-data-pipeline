...
# Test tick data download with ACTUAL HISTORICAL DATA
# Using DIS 108C that expires 2025-12-05
# Data available from Nov 6-14, 2024

echo "Testing tick data download for DIS 108C (Dec 5 expiry)"
echo "Using data from November 14, 2024 (yesterday)"
echo ""

# Download entry window ticks (3:00-3:30pm on Nov 14)
